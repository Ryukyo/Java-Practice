...
public class MobilePhone {
    ...
    public boolean updateContact (Contact oldContact, Contact newContact) {
        ...
        if (foundPosition < 0) {
            System.out.println(oldContact.getName() + " is not in your contact list ");
            return false;
        }
        else if (findContact(newContact.getName()) != -1){
            System.out.println("Contact with name " + newContact.getName() + " already exists. Update not sucessful");
            return false;
        }
    ...
    public boolean removeContact(Contact contact) {
        ...
        if (foundPosition < 0) {
            System.out.println(contact.getName() + " is not in your contact list ");
            return false;
        }
